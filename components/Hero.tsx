...
export default function Hero() {
  ...
  return (
    <section 
      ref={containerRef} 
      className="min-h-screen w-full bg-black text-white flex flex-col justify-between p-6 md:p-12 relative overflow-hidden select-none"
    >
      {/* Top Nav */}
      <div className="flex justify-between items-center w-full text-[10px] md:text-[11px] tracking-[0.3em] uppercase text-zinc-500 font-medium pt-2">
